...
class tests(unittest.TestCase):
    ...
    def test_add_book_to_list(self):
        ...
        self.assertIsInstance(self.book_list.books[0], Book)
    ...
    def test_remove_book_by_index_from_list(self):
        ...
        self.book_list.add_book(Book())
        self.book_list.remove_book_by_id(0)
        self.assertEqual(self.book_list.books, [])

        self.assertRaises(ValueError, self.book_list.remove_book_by_id, 1)

        self.assertRaises(TypeError, self.book_list.remove_book_by_id, "hello")
        self.assertRaises(TypeError, self.book_list.remove_book_by_id, Book())
    ...
    def test_remove_book_by_object_from_list(self):
        ...
        self.assertRaises(ValueError, self.book_list.remove_book_by_object, Book())

        self.assertRaises(TypeError, self.book_list.remove_book_by_object, "hello")
        self.assertRaises(TypeError, self.book_list.remove_book_by_object, 21)
        self.assertRaises(TypeError, self.book_list.remove_book_by_object, None)
    ...
    def test_get_book_by_id_from_list(self):
        ...
        book = Book()
        self.book_list.add_book(book)
        self.assertEqual(self.book_list.get_book_by_id(0), book)
