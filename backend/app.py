...
@app.route("/favorites/<string:user_id>/remove/<string:book_id>", methods=["DELETE"])
...
@app.route("/read_books/<string:user_id>/remove/<string:book_id>", methods=["DELETE"])
...
@app.route("/want_to_reads/<string:user_id>/remove/<string:book_id>", methods=["DELETE"])
